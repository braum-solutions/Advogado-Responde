...
public class Utils {
    ...
    public static final String[] REASON_BR = {"Motivo", "Conteúdo impróprio", "Sem conteúdo suficiente", "Insulto", "Outro"};
    public static final String[] REASON_EN = {"Reason", "Inappropriate content", "Not enough content", "Insult", "Other"};
